...
const SECTIONS = [
  {
    icon: ShieldCheck,
    title: "1. نظرة عامة",
    body: "توضح سياسة الخصوصية هذه كيف تقوم Pet Keepsake Studio بجمع معلوماتك الشخصية واستخدامها وتخزينها وحمايتها عند زيارتك لموقعنا الإلكتروني، أو تحميل الصور، أو تقديم طلب، أو التواصل معنا.",
  },
  {
    icon: Cookie,
