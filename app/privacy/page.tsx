...
const SECTIONS = [
  {
    icon: ShieldCheck,
    title: "1. Overview",
    body: "This Privacy Policy explains how Pet Keepsake Studio collects, uses, stores, and protects your personal information when you visit our website, upload photos, place an order, or contact us.",
  },
  {
    icon: Cookie,
