...
const SECTIONS = [
  {
    icon: Receipt,
    title: "1. نظرة عامة",
    body: "في Pet Keepsake Studio، نحن نبيع منتجات رقمية مخصصة فقط. وبما أن طلبك يتم تسليمه إلكترونيًا وقد يتم إنشاؤه من خلال سير عمل آلي لمعالجة الصور بعد الشراء، فإن المبالغ المستردة والإرجاع والاستبدال والإلغاء تكون محدودة بشكل عام بعد بدء المعالجة أو التسليم.",
  },
  {
    icon: Download,
